...
write_csv(data, here::here("data-processed", "data_filtered.csv"))
...
write_csv(feedback, here::here("data-processed", "results_feedback.csv"))
...
write_csv(choiceData, here::here("data-processed", "choiceData.csv"))
...
write_csv(data_comb_50k, here::here("data-processed", "data_filtered_50k.csv"))
...
choiceData <- read_csv(here("data-processed", "choiceData.csv"))
...
write_csv(choiceData_comb_50k, here::here("data-processed", "choiceData_comb_50k.csv"))
